...
class PersonController extends Controller
{
    ...
    public function index() {
        $people = Person::latest()->paginate($this->perPage);
        return view($this->route.'.index', ['people' => $people]);
    }
    ...
    public function create()
    {
        ...
        $data = ['route' => $this->route.'.index', 'method' => 'post'];
    ...
    private function validity($request, $update = false) {
        if (!$update) {
            ...
            $person = Person::where([['first_name', '=', $request->get('first_name')], 
    ...
    public function edit($id) {
        ...
        $data = ['person' => $person, 'route' => $this->route.'.update', 'method' => 'patch'];
        $data['notification_type'] = 'inline';
    ...
    public function update(Request $request) {
        ...
        try {
            DB::beginTransaction();
            Person::where('id', '=', $id)->update($values);
    ...
    public function fetcher(Request $request) {
        ...
        foreach ($urls as $url) {
            ...
            $person = Person::where([['first_name', '=', $bio['first_name']], 
            ...
            if (!$person && count($validation->errors()->messages()) == 0) {
                ...
                $values = array_merge($fields, ['slug' => $slug, 'birth_day' => $birth_day, 'birth_month' => $birth_month, 'age' => $age,
