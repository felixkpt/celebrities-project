...
<div class="flex flex-col w-full my-2">
    ...
    <div class="w-full rounded-lg">
        ...
        <div class="flex w-full my-8 justify-center">
            <div class="flex">
                <a class="text-2xl rounded-lg py-1 transition ease-in-out duration-500 px-12 font-medium text-[#2e265a]  hover:text-[#302a4c] bg-fuchsia-50 hover:bg-fuchsia-100  border border-[#2e265a] hover:border-[#302a4c]" href="{{ url('people/mbti/'.$personality->slug.'s') }}">More {{ $personality->name }}s</a>
            </div>
        </div>
    </div>
